...
theme_pdf = function (base_size = 16, base_family = "", font_size = 16,
  line_size = 0.3, rel_small = 12/14, rel_tiny = 11/14, rel_large = 16/14) 
{
  half_line = font_size/2
  small_size = rel_small * font_size
  theme(
    line = element_line( color = "black", size = 0.3, linetype = 1, 
      lineend = "butt"),
    rect = element_rect(fill = NA, color = "black", size = 0.3, linetype = 1),
    ...
    panel.border = element_rect(color = "black", fill = NA, size = line_size * 3),
    ...
    strip.switch.pad.wrap = unit(0.01, "cm"),
