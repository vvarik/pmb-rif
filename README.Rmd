...
knitr::opts_chunk$set(echo=FALSE, warning=FALSE, message=FALSE, dpi=300, fig.path = "output/fig/")
...
Table 1: Mutants with altered RIF-PMB interaction profile and corresponding gene in _E. coli_.

```{r}
getValidHitTable() %>% addEcOrthologs() %>% .[,-'locus_pa'] %>% knitr::kable()
```

Only four genes had designated orthologs in _E. coli_.


Table 2 : Biological context of mutants.

```{r}
getGoTermTable() %>% knitr::kable()
```
